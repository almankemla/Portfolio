...
export default function SocialNetworkRowStack() {
	return (
		<SocialMediaContainer>
			...
			<ButtonSocialMediaIcon href="https://github.com/almankemla" target="_blank">
				<Github />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="mailto:contact.nkemlaalma@gmail.com" target="_blank">
				<MailSend />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://www.linkedin.com/in/almankemla/	" target="_blank" data-splitbee-event="linkedin-access">
				<LinkedinSquare />
			</ButtonSocialMediaIcon>
