...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head
				title="Alma Nkemla | Portfolio"
				metaDescription="Alma Nkemla's complete portfolio, projects and experiences"
				keywords="Alma Nkemla, Cybersecurity, Programming, Security analysis, Software developper"
			/>
			<LandingPageContainer>

				<TitleLandingContainer>
					<SubTitleLanding>{language.landingPage.apresentationText}</SubTitleLanding>
					<Typed strings={["Alma Nkemla"]} typeSpeed={80} className="type-string " />
